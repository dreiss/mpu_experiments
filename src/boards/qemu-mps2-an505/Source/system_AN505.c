...
/*---------------------------------------------------------------------------
  Define clocks
 *---------------------------------------------------------------------------*/
// From QEMU's mps2-tz.c
#define SYSTEM_CLOCK    (20000000u)
...
{
/* Initialize VTOR if available */
#if defined (__VTOR_PRESENT) && (__VTOR_PRESENT == 1U)
  SCB->VTOR = (uint32_t)(&__VECTOR_TABLE[0]);
#endif

/* Enable co-processor if it is used */
